...
int main(int argc, char **argv)
{
  if (argc < 6) 
  {
    printf("!Usage: <this> [b <angular mode number> <radial mode number>] or [g <center> <radius> <amplitude>] N dt\nUse b for a Bessel-function initial condition or g for a Gaussian-bump initial condition.\n");
    exit(0);
  }
  char mode=argv[1][0];
  int m,n,frameskip;
